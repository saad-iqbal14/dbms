...
<!----	start navigation --->
	<nav class="navbar navbar-expand-lg navbar-dark bg-darkk" style="background: radial-gradient(circle, rgba(223,5,69,1) 0%, rgba(10,45,87,1) 100%);">
  <a class="navbar-brand yolo" href="#" style="">YOLO</a>
...
<section class="bg-primaryy" style="background: radial-gradient(circle, rgba(223,5,69,1) 0%, rgba(10,45,87,1) 100%);">
	<article>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div >
      <a href="r2.php" style="text-align: center;" class="text-primary"> Click here to Signup</a>
      </div>
			</form>
        </div>
